...
def read_train_test_directory_to_str(directory):
    ...
    for dirname in dirnames:
        ...
        camera_indices += [1 for f in filenames]
        # tracklet_indices += [int(f[7:11]) for f in filenames]
        tracklet_indices += [1 for f in filenames]

    return image_filenames, ids, camera_indices, tracklet_indices


def read_train_test_directory_to_image(directory, image_shape=(96, 96)):
...
def read_train_split_to_image(dataset_dir, image_shape=(96, 96)):
...
def read_test_split_to_image(dataset_dir, image_shape=(96, 96)):
