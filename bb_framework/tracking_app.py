...
def run(seq_dir,
        ...
        nn_budget, conf_thresh,bs,app_model,det_model,imdim,display,CalibImageSize,app_resize):
    ...
    sequence.appearances = get_appearance_descriptors(sequence,app_model,bs,app_resize)
